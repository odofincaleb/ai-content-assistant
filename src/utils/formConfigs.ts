...
interface FormConfig {
  ...
  template: string;
  tones?: string[];
  toneQuestionIndex?: number;
  numberQuestionIndex?: number;
  note?: string;
  dynamicFields?: {
    triggerFieldIndex: number;
...
export const formConfigs: Record<string, FormConfig> = {
  ...
  'LinkedIn Post': {
    ...
    examples: [
      ...
      'Example: to share insights and start a discussion',
      'Example: professional, informative',
      'Example: The Future of AI: What You Need to Know'
    ],
    template: 'Write an engaging LinkedIn post about {1} for the target audience of {2}. The purpose of the post is {3}, and it should have a {4} tone of voice. Include an eye-catching title: {5}. The post should be professional, informative, and encourage engagement from the LinkedIn community.',
    tones: toneOptions,
    toneQuestionIndex: 3
  },
  'INSTAGRAM CAPTION': {
    questions: [
      'What is the main topic or theme of the Instagram post?',
      'Who is the target audience?',
      'What is the purpose of the post?',
      'What tone of voice should the caption have?',
      'How many hashtags would you like to include?'
    ],
    examples: [
      'Example: healthy breakfast ideas',
      'Example: health-conscious individuals, food enthusiasts',
      'Example: to inspire and educate about healthy eating',
      'Example: casual, friendly',
      'Example: 10'
    ],
    template: 'Write an engaging Instagram caption about {1} for the target audience of {2}. The purpose of the post is {3}, and it should have a {4} tone of voice. Include {5} relevant hashtags to increase discoverability. The caption should be visually appealing, encourage engagement, and align with Instagram\'s community guidelines.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'TWITTER POST': {
    questions: [
      'What is the main topic of the Twitter post?',
      'Who is the target audience?',
      'What is the purpose of the post?',
      'What tone of voice should the post have?',
      'How many hashtags would you like to include?'
    ...
    examples: [
      ...
      'Example: professionals, students',
      'Example: to share valuable insights and tips',
      'Example: casual, informative',
      'Example: 3'
    ],
    template: 'Write a compelling Twitter post about {1} for the target audience of {2}. The purpose of the post is {3}, and it should have a {4} tone of voice. Include {5} relevant hashtags to increase visibility. Keep the post concise, engaging, and within Twitter\'s character limit while delivering value to the audience.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'YOUTUBE DESCRIPTIONS': {
    questions: [
      ...
      'What tone of voice should the description have?',
      'How many tags would you like to include?'
    ],
    examples: [
      'Example: cooking tutorial',
      'Example: cooking enthusiasts, beginners',
      'Example: to teach and entertain viewers',
      'Example: friendly, informative',
      'Example: 15'
    ],
    template: 'Write an engaging YouTube video description for a video about {1} targeted at {2}. The main purpose of the video is {3}, and the description should have a {4} tone of voice. Include {5} relevant tags to improve discoverability. The description should be informative, engaging, and encourage viewers to watch the video while providing relevant context and information.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  ...
  'YOUTUBE SCRIPT': {
    questions: [
      ...
      'What is the main purpose of the video?',
      'What tone of voice should the script have?',
    ...
    template: 'Write an engaging YouTube video script about {1} for the target audience of {2}. The main purpose of the video is {3}, and the script should have a {4} tone of voice. The video should be approximately {5} minutes long. The script should be engaging, informative, and encourage viewer engagement while providing valuable content.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'YOUTUBE HOOKS': {
    questions: [
      ...
      'Who is the target audience?',
      'What type of hook do you want?',
      'How many hooks would you like to generate?'
    ],
    examples: [
      'Example: productivity tips',
      'Example: professionals, students',
      'Example: question, story, statistic',
      'Example: 5'
    ],
    template: 'Generate {4} compelling YouTube video hooks for a video about {1} targeted at {2}. The hooks should be {3} type and designed to grab the viewer\'s attention within the first few seconds. Each hook should be unique and encourage viewers to continue watching the video.',
    tones: toneOptions,
    numberQuestionIndex: 3
  },
  'YOUTUBE OUTLINES': {
    ...
    template: 'Create a detailed YouTube video outline for a {3} video about {1} targeted at {2}. The outline should include {4} main points and be structured to maintain viewer engagement throughout the video. Include timestamps, key talking points, and transitions between sections.',
    tones: toneOptions,
    numberQuestionIndex: 3
  },
  'YOUTUBE SHORTS': {
    questions: [
      'What is the main topic of the YouTube Short?',
      'Who is the target audience?',
      'What is the main message or takeaway?',
      'What tone should the short have?'
    ],
    examples: [
      'Example: quick cooking tip',
      'Example: busy professionals',
      'Example: save time in the kitchen',
      'Example: casual, helpful'
    ],
    template: 'Write a YouTube Short script about {1} for {2}. The main message should be {3}, and the tone should be {4}. Keep it concise, engaging, and optimized for the short-form video format. Include a strong hook and clear call-to-action.',
    tones: toneOptions,
    toneQuestionIndex: 3
  },
  'YOUTUBE HASHTAGS': {
    ...
    template: 'Generate {2} relevant hashtags for a YouTube video about {1} targeted at {3}. The hashtags should help the video rank higher in search results and reach the target audience. Include a mix of broad and specific hashtags.',
    tones: toneOptions,
    numberQuestionIndex: 1
  },
  'YOUTUBE TAGS': {
    ...
    template: 'Generate {2} relevant tags for a YouTube video about {1}. The tags should help the video rank higher in search results and reach a larger audience. Make sure the tags are closely related to the content of the video.',
    tones: toneOptions,
    numberQuestionIndex: 1
  },
  'TIKTOK VIDEO SCRIPT': {
    questions: [
      'What is the main topic of the TikTok video?',
      'Who is the target audience?',
      'What is the main message or takeaway?',
      'What tone should the video have?'
    ],
    examples: [
      'Example: quick life hack',
      'Example: Gen Z, millennials',
      'Example: save money easily',
      'Example: fun, relatable'
    ],
    template: 'Write a TikTok video script about {1} for {2}. The main message should be {3}, and the tone should be {4}. Keep it short, engaging, and optimized for TikTok\'s format. Include trending elements and encourage engagement.',
    tones: toneOptions,
    toneQuestionIndex: 3
  },
  'TIKTOK VIDEO HOOKS': {
    ...
    template: 'Generate {3} compelling TikTok video hooks for a video about {1} targeted at {2}. The hooks should be designed to grab attention within the first few seconds and encourage viewers to watch the entire video.',
    tones: toneOptions,
    numberQuestionIndex: 2
  },
  'TIKTOK VIDEO IDEAS': {
    questions: [
      'What is your niche or main topic?',
      'Who is your target audience?',
      'How many video ideas would you like to generate?'
    ],
    examples: [
      'Example: fitness',
      'Example: fitness enthusiasts',
    ...
    template: 'Generate {3} engaging TikTok video ideas for the {1} niche targeted at {2}. The ideas should be trending, shareable, and designed to increase engagement and followers.',
    tones: toneOptions,
    numberQuestionIndex: 2
  },
  'MINI-VSL (VIDEO SALES LETTER)': {
    questions: [
      ...
      'Who is the target audience?',
      'What is the main problem the product solves?',
      'What is the main benefit or solution?',
      'How long should the VSL be (in minutes)?'
    ],
    examples: [
      'Example: online course',
      'Example: aspiring entrepreneurs',
      'Example: lack of business knowledge',
      'Example: step-by-step business guidance',
      'Example: 5'
    ],
    template: 'Write a {5}-minute mini-VSL script for {1} targeted at {2}. The script should address the problem of {3} and present {1} as the solution that provides {4}. Include a compelling hook, problem identification, solution presentation, and strong call-to-action.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'DIGITAL PRODUCT VIDEO': {
    questions: [
      'What is the digital product being promoted?',
      'Who is the target audience?',
    ...
    examples: [
      ...
      'Example: comprehensive guide, instant access',
      'Example: download now',
      'Example: 60'
    ],
    template: 'Create a {5}-second video script to promote the digital product {1} targeted at {2}. Highlight the main features and benefits: {3}. Include a compelling call-to-action: {4}. The script should be engaging and clearly communicate the value of the digital product.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'TUTORIAL VIDEO': {
    questions: [
      ...
      'Who is the target audience?',
      'What skill level is the tutorial for?',
      'How long should the tutorial be (in minutes)?'
    ],
    examples: [
      'Example: Photoshop basics',
      'Example: beginners',
      'Example: beginner level',
      'Example: 10'
    ],
    template: 'Write a {4}-minute tutorial video script about {1} for {2} at a {3} skill level. The script should be clear, step-by-step, and easy to follow. Include an introduction, main content with clear instructions, and a conclusion.',
    tones: toneOptions,
    toneQuestionIndex: 2,
    numberQuestionIndex: 3
  },
  'INFORMATIONAL VIDEO': {
    questions: [
      'What is the main topic of the informational video?',
      'Who is the target audience?',
      'What is the main purpose of the video?',
      'How long should the video be (in minutes)?'
    ],
    examples: [
      ...
      'Example: to educate and raise awareness',
      'Example: 8'
    ],
    template: 'Create a {4}-minute informational video script about {1} for {2}. The main purpose is {3}. The script should be informative, engaging, and easy to understand. Include an introduction, main content with key points, and a conclusion.',
    tones: toneOptions,
    toneQuestionIndex: 2,
    numberQuestionIndex: 3
  },
  'ANNOUNCEMENT VIDEO': {
    ...
    examples: [
      ...
      'Example: customers and followers',
      'Example: exciting, professional',
      'Example: 30'
    ],
    template: 'Write a {4}-second announcement video script about {1} for {2}. The tone should be {3}. The script should be clear, engaging, and include all necessary information about the announcement.',
    tones: toneOptions,
    toneQuestionIndex: 2,
    numberQuestionIndex: 3
  },
  'AMAZON VIDEO SCRIPT': {
    questions: [
      'What is the Amazon product being promoted?',
      'What are the main features of the product?',
      'Who is the target audience?',
      'What is the main benefit or problem it solves?',
      'How long should the video be (in seconds)?'
    ],
    examples: [
      'Example: wireless headphones',
      'Example: noise cancellation, long battery life',
      'Example: music lovers, professionals',
      'Example: crystal clear sound quality',
      'Example: 60'
    ],
    template: 'Create a {5}-second Amazon video script for {1}. Highlight the main features: {2}. Target the audience of {3}. Emphasize the main benefit: {4}. The script should be compelling and encourage viewers to purchase the product.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  ...
  'LONG SALES COPY': {
    ...
    examples: [
      'Example: online course',
      'Example: aspiring entrepreneurs',
      'Example: comprehensive learning, expert guidance, practical skills',
      'Example: step-by-step business building approach',
      'Example: persuasive, professional'
    ],
    template: 'Write a compelling long-form sales copy for {1} targeted at {2}. The copy should highlight the top 3 benefits: {3}, and emphasize the unique selling proposition: {4}. Use a {5} tone of voice to create a persuasive and engaging sales message that converts prospects into customers.',
    tones: toneOptions,
    toneQuestionIndex: 4
  },
  'SHORT SALES COPY': {
  ...
  'AMAZON SPONSORED BRAND ADS HEADLINE': {
    ...
    template: 'Create an Amazon Sponsored Brand Ads headline for {1} that highlights the key features or selling points: {2}. The headline should have a {3} tone of voice and be optimized for Amazon\'s advertising platform to drive clicks and conversions.',
    tones: toneOptions,
    toneQuestionIndex: 2
  },
  ...
  'NICHE IDEAS': {
    questions: [
      'What is your main area of interest or expertise?',
      'What is your target audience?',
      'How many niche ideas would you like to generate?'
    ],
    examples: [
    ...
    template: 'Generate {3} profitable niche ideas within the {1} area, specifically targeting {2}. Each niche should have potential for monetization and audience engagement. Consider sub-niches, emerging trends, and underserved markets within your main area of interest.'
  },
  ...
  'EBOOK AUTHOR BIO': {
    ...
    examples: [
      "Example: What is your name or the name of the author?",
      "Example: What is your area of expertise or specialization?",
      "Example: How many years of experience do you have in your field?",
      "Example: What are your relevant credentials, certifications, or qualifications?",
      "Example: What is your mission or purpose as an author?"
    ],
    template: `Write an engaging author bio for {1}, an expert in {2} with {3} of experience. Include relevant credentials such as {4} and emphasize the author's mission: {5}. The bio should establish credibility, build trust with readers, and create a connection between the author and the target audience.`
  },
  'SEO META TAGS': {
    questions: [
  ...
  'TRANSLATE': {
    questions: [
      "What is the content you want to translate?",
      "What language do you want to translate to?",
      "What tone of voice should the translation have?"
    ],
    examples: [
    ...
    template: `Translate the following content: {1} into {2}. The translation should maintain a {3} tone of voice and preserve the original meaning and context of the content. Ensure the translation is natural and appropriate for the target language and culture.`,
    tones: toneOptions,
    toneQuestionIndex: 2
  },
  'SHORT AD VIDEO': {
  ...
  'MAKE IT EASY-TO-READ': {
    questions: [
      'What is the content you want to make easy-to-read?',
      'What is the target audience for the simplified content?',
      'What tone of voice should the simplified content have?'
    ],
    examples: [
      'Example: Paste your complex content here',
      'Example: general audience, beginners',
      'Example: simple, clear'
    ],
    template: 'Simplify and rewrite the following content to make it easy-to-read for {2}: {1}. Use a {3} tone of voice and break down complex concepts into simple, understandable language. Ensure the content is accessible and engaging for the target audience.',
    tones: toneOptions,
    toneQuestionIndex: 2
  },
  'POEM GENERATOR': {
    questions: [
      'What is the theme or topic of the poem?',
      'What type of poem do you want to create?',
      'What tone or mood should the poem have?',
      'How many lines should the poem have?'
    ],
    examples: [
      'Example: love, nature, friendship',
      'Example: sonnet, haiku, free verse',
      'Example: romantic, melancholic, joyful',
      'Example: 14'
    ],
    template: 'Create a {2} poem about {1} with a {3} tone or mood. The poem should have {4} lines and be engaging, creative, and emotionally resonant. Use vivid imagery and poetic language to bring the theme to life.',
    tones: toneOptions,
    toneQuestionIndex: 2,
    numberQuestionIndex: 3
  },
  'PRESS RELEASE': {
    questions: [
      'What is the headline or main announcement?',
      'Who is the company or organization making the announcement?',
      'What are the key details or facts of the announcement?',
      'What is the target audience for the press release?',
      'What is the call to action or next steps?'
    ],
    examples: [
      'Example: New Product Launch',
      'Example: TechCorp Inc.',
      'Example: Revolutionary new technology that improves efficiency',
      'Example: journalists, industry professionals',
      'Example: Contact us for more information'
    ],
    template: 'Write a professional press release with the headline "{1}" from {2}. Include the key details: {3}. The press release should be targeted at {4} and include a clear call to action: {5}. Use a professional tone and follow standard press release format.',
    tones: toneOptions,
    toneQuestionIndex: 3
  },
  'CONTENT WRITER': {
    questions: [
      'What is the topic or subject for the content?',
      'Who is the target audience?',
      'What type of content do you want to create?',
      'What tone of voice should the content have?',
      'How many words should the content be?'
    ],
    examples: [
      'Example: digital marketing trends',
      'Example: marketing professionals',
      'Example: blog post, article, guide',
      'Example: professional, informative',
      'Example: 800'
    ],
    template: 'Create a {3} about {1} for the target audience of {2}. Use a {4} tone of voice and write approximately {5} words. The content should be engaging, informative, and valuable to the target audience.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 4
  },
  'EBOOK HEADLINES AND SUBHEADLINE': {
    questions: [
      ...
      'Who is your target audience?',
      'How many headlines and subheadlines do you want?',
      'What tone should the headlines have?'
    ],
    examples: [
      'Example: productivity tips',
      'Example: busy professionals',
      'Example: 5',
      'Example: compelling, professional'
    ],
    template: 'Generate {3} compelling headlines and subheadlines for an ebook about {1} targeted at {2}. Use a {4} tone to make the headlines engaging and persuasive. Each headline should be attention-grabbing and clearly communicate the value of the content.',
    tones: toneOptions,
    toneQuestionIndex: 3,
    numberQuestionIndex: 2
  },
  'EBOOK INTRODUCTION': {
    questions: [
      ...
      'Who is your target audience?',
      'What tone should the introduction have?',
      'What is the main promise or benefit of the ebook?'
    ],
    examples: [
      'Example: The Complete Guide to Digital Marketing',
      'Example: digital marketing strategies',
      'Example: marketing beginners',
      'Example: engaging, professional',
      'Example: master digital marketing in 30 days'
    ],
    template: 'Write an engaging introduction for the ebook "{1}" about {2} for the target audience of {3}. Use a {4} tone and clearly communicate the main promise: {5}. The introduction should hook the reader and set expectations for the valuable content ahead.',
    tones: toneOptions,
    toneQuestionIndex: 3
  },
  'FIND A NICHE': {
    questions: [
      'What is your main area of interest or expertise?',
      'What is your target audience?',
      'How many niche ideas do you want to explore?'
    ],
    examples: [
      'Example: fitness and wellness',
      'Example: busy professionals',
    ...
    template: 'Find {3} profitable niche opportunities within the {1} area, specifically targeting {2}. Each niche should have potential for monetization, audience engagement, and growth. Consider underserved markets and emerging trends.',
    tones: toneOptions,
    numberQuestionIndex: 2
  },
  'GET AN EBOOK IDEA': {
    questions: [
      'What is your main area of expertise or interest?',
      'Who is your target audience?',
      'How many ebook ideas do you want to generate?'
    ],
    examples: [
      'Example: cooking and recipes',
      'Example: beginner cooks',
      'Example: 5'
    ],
    template: 'Generate {3} compelling ebook ideas in the {1} area for the target audience of {2}. Each idea should have potential for monetization and provide genuine value to readers. Consider current trends and market gaps.',
    tones: toneOptions,
    numberQuestionIndex: 2
  },
  'FACEBOOK AD VIDEO': {
  ...
  'SUPPORT AUTORESPONDER MESSAGE': {
    ...
    template: 'Create an autoresponder message for {1} that acknowledges receipt of support inquiries and provides an estimated response time of {2}. The message should be professional, reassuring, and provide alternative resources or contact methods if available. Thank you!'
  },
  'ENGAGING QUESTIONS': {
    questions: [
  ...
  'CRISIS OR ISSUE PRESS RELEASE': {
    ...
    examples: [
      ...
      'John Smith, CEO of ClearWater Corp',
      'www.clearwater-corp.com/updates'
    ],
    template: 'FOR IMMEDIATE RELEASE:\n\n{1} Addresses Recent Issue with Transparency and Commitment\n{1} acknowledges the situation regarding {2}. In response, {3}. {1} is committed to resolving this matter and has implemented the following immediate steps: {4}.\nFor further information or inquiries regarding this situation, please contact {5}. Regular updates and detailed information can be found at {6}.'
  },
